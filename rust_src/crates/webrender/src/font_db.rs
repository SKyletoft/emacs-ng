...
impl FontDB {
    ...
    // https://github.com/servo/font-kit/blob/v0.11.0/src/source.rs#L45
    // https://github.com/RazrFalcon/fontdb/blob/v0.11.1/src/lib.rs#L158
    // macOS/Windows are all hardcoded
    #[cfg(all(unix, not(target_os = "macos")))]
